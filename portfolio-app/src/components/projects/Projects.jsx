          ...
          <div className="box">
            ...
            <div className="content">
              ...
              <p>
                ...
                users to log in, register, and place orders with seamless
                checkout. Implemented React, Express, and PostgreSQL in
                Javascript for a dynamic user experience.
              </p>
          ...
          <div className="box">
            ...
            <div className="content">
              ...
              <p>
                ...
                experience.Implemented an efficient navigation bar, elevating
                user experience and streamlining platform navigation. Developed
                a robust forum application enabling users to create posts, send
                messages, and manage their profiles effortlessly.
              </p>
              <div className="project-image-container">
                <a
